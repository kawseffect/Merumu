...
export default {
  ...
  async execute(client, interaction) {
    ...
    if (subcommandGroup === 'set') {
      if (subcommand === 'roles') {
        ...
        if (rolee) {
          const embed = new MessageEmbed()
            ...
            .setDescription(
              client.emotes +
                ` | You have Configured the whitelisting role, the role ${rolee.toString()} has been added to whitelisting `
            );
          ...
          const embed = new MessageEmbed()
            ...
            .setDescription(
              client.emotes +
                ` | You have Configured the whitelisting role, the role ${role.toString()} has been deleted from whitelisting `
            );
          interaction.reply({ embeds: [embed] });
      ...
      const { whitelistbw } = await client.db.updateGuild(interaction.guild.id);
